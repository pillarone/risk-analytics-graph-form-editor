...
// TODO --> no fixed paths --> use the resources mechanism ...
    private final static Icon closeIcon = new ImageIcon(CloseableTabRenderer.class.getResource("/org/pillarone/riskanalytics/graph/formeditor/application/resources/icons/close-active.png"));
    private final static Icon rolloverIcon = new ImageIcon(CloseableTabRenderer.class.getResource("/org/pillarone/riskanalytics/graph/formeditor/application/resources/icons/close-inactive.png"));
